...
//        double k=4.12*Math.pow(10, 11)*2000/(4*2.13*Math.pow(10, 5)*114*Math.pow(10, 7));
        ...
        ei[0]=new EndInfo(node[memb[0][0]],node[memb[0][1]],new String[]{""+k,"r"});
        ...
        ei[2]=new EndInfo(node[memb[2][0]],node[memb[2][1]],new String[]{""+k,"r"});
        ...
        double S=100;
        NodeLoadInfo[] NLI={new NodeLoadInfo(1,new double[] {1,0,0}),new NodeLoadInfo(3,new double[] {-1,0,0})};
